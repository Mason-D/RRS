    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 40, 240, true, 1, 1, new DateTime(2022, 4, 6, 7, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 60, 180, true, 1, 2, new DateTime(2022, 4, 6, 13, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, 80, 300, true, 1, 3, new DateTime(2022, 4, 6, 18, 0, 0, 0, DateTimeKind.Unspecified) },
            ...
            migrationBuilder.InsertData(
                table: "Sittings",
                columns: new[] { "Id", "Capacity", "Duration", "IsOpen", "RestaurantId", "SittingTypeId", "Start" },
                values: new object[] { 82, 40, 240, true, 1, 1, new DateTime(2022, 5, 3, 7, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Sittings",
                columns: new[] { "Id", "Capacity", "Duration", "IsOpen", "RestaurantId", "SittingTypeId", "Start" },
                values: new object[] { 83, 60, 180, true, 1, 2, new DateTime(2022, 5, 3, 13, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Sittings",
                columns: new[] { "Id", "Capacity", "Duration", "IsOpen", "RestaurantId", "SittingTypeId", "Start" },
                values: new object[] { 84, 80, 300, true, 1, 3, new DateTime(2022, 5, 3, 18, 0, 0, 0, DateTimeKind.Unspecified) });
